<script lang="ts" module>
    ...
    export const sidebarMenuButtonVariants = tv({
        base:
            "flex w-full items-center overflow-hidden gap-2 p-2" +
            "rounded-md text-left text-sm transition-[width,height,padding] " +
            "ring-sidebar-ring " +
            ...
            "focus-visible:ring-2 data-active:font-medium peer/menu-button group/menu-button " +
            "outline-hidden " +
