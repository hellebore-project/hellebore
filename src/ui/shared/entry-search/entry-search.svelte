...
>
	<div class="relative">
		<SearchIcon class="text-muted-foreground absolute start-2 top-1/2 size-6 -translate-y-1/2"/>
	...
	<ComboboxPortal>
		<ComboboxContent>
			<ComboboxScrollUpButton class="flex w-full items-center justify-center py-1">
			...
			<ComboboxScrollDownButton class="flex w-full items-center justify-center py-1">
